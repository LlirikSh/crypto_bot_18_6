...
def help(message: telebot.types.Message):
    text = 'Приветствую, для того чтобы начать работу введите команду боту в формате:\n <имя валюты> ' \
           '<в какую валюту перевести> <количество переводимой валюты> \n' \
           ' Пример ввода данных: Биткоин Доллар 1 \n' \
...
def get_price(message: telebot.types.Message):
    try:
        ...
        if len(values) != 3:
            raise ConvertionException('Количество параметров не совпадает. Необходимо использовать формат:\n<имя валюты> ' \
           '<в какую валюту перевести> <количество переводимой валюты> \n')
